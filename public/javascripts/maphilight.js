(function($) {
	...
	if(has_canvas) {
		...
		add_shape_to = function(canvas, shape, coords, options, name, opacity) {
			...
			if(options.fill) {
				...
				context.fillStyle = css3color(options.fillColor, parseFloat(opacity));
				context.fill();
			}
			if(options.stroke) {
		...
		add_shape_to = function(canvas, shape, coords, options, name, iopacity) {
		...
		return this.each(function() {
			...
			mouseover = function(e) {
				...
				if(
					...
					add_shape_to(canvas, shape[0], shape[1], area_options, "highlighted", $(this).attr('class'));
