...
desc 'Generate documentation for the advanced_reporting extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'AdvancedReportingExtension'
...
desc 'Test the advanced_reporting extension.'
...
namespace :test do
  desc 'Functional test the advanced_reporting extension.'
  ...
  desc 'Unit test the advanced_reporting extension.'
